...
from inv_methods import Inversion
import json
from custom_sd import *
import time
...
def main(
    ...
    inversion = Inversion(ldm_stable, K_round=K_round, num_ddim_steps=num_of_ddim_steps,
    ...
    for i,(_, item) in enumerate(editing_instruction.items()):
        ...
        inv_latent = inversion.invert(latent, prompt, guidance_scale)[-1]
        end_time = time.time()
